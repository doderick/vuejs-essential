      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body" data-validator-form>
          ...
          <div class="form-group">
            ...
            <input type="password" id="password" v-validator.required="{ regex: /^\w{6,16}$/, error: '密码要求 6 ~ 16 个单词字符' }" class="form-control" placeholder="请填写密码">
          </div>
          <div class="form-group">
            <label for="" class="control-label">确认密码</label>
            <input type="password" v-validator.required="{ target: '#password' }" class="form-control" placeholder="请再填写一次密码">
          </div>
          <div class="form-group">
            <label for="" class="control-label">图片验证码</label>
            <input type="text" v-validator.required="{ title: '图片验证码' }" class="form-control" placeholder="请填写验证码">
          </div>
