        ...
        <div class="panel-body">
          ...
          <div data-validator-form>
            <div class="form-group">
              <input type="text" v-model.trim="title" v-validator:blur.required="{ title: '标题' }" class="form-control" placeholder="请填写标题" @input="saveTitle">
            </div>
            <div class="form-group">
              <!-- <textarea validator.required="{ title: '内容' }" class="form-control" placeholder="请使用 Markdown 格式书写 ;-)，代码片段黏贴时请注意使用高亮语法。"></textarea> -->
              <textarea id="editor"></textarea>
            </div>
            <br>
            <div class="form-group">
              <button type="submit" class="btn btn-primary" @click="post">发　布</button>
            </div>
          </div>
        </div>
      </div>
