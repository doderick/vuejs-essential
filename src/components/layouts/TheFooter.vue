    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-5 col-lg-5">
          ...
          <div class="text-md">
            <a :href="item.link" v-for="(item, index) in contacts" v-bind:key="index" v-title="item.title" :style="contactStyle" target="_blank">
              ...
              <ul class="list-unstyled">
                <li v-for="(item, index) in sponsor.list" v-bind:key="index">
                  <a :href="item.link" target="_blank">
                    <img :src="item.logo" :alt="item.title" v-title="item.title" class="footer-sponsor-link" width="98">
                  </a>
                </li>
              </ul>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      contacts: [
        {
          icon: 'envelope',
          title: '反馈问题',
          link: 'mailto:doderick@outlook.com'
        },
        {
          icon: 'weibo',
          title: '站长微博',
          link: 'https://weibo.com/5069076526/profile?rightmod=1&wvr=6&mod=personinfo'
        },
        {
          icon: 'weixin',
          title: '加我微信',
      ...
      designer: `
        <span style="font-size:0.9em">Coded by
          <span style="color: #e27575;font-size: 14px;">❤</span>
          <a href="https://github.com/doderick" target="_blank" style="color:inherit">doderick</a>
        </span>
      `,
      sponsor: {
        title: '赞助商',
